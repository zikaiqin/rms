...
--7)Quel est le nom du gardien 'ASC', le id des parcelles qu'il surveille et le nom des secteurs dont les parcelles font partie?
...
--8) Quels gardiens surveillent quelles parcelles quand et quel est le nom du secteur de la parcelle?
...
--9) Pour les gardiens, donnez le code mnémotechnique, nom complet et le nom des secteurs de ceux qui surveillent des parcelles.
...
--10) Quels sont les noms des chefs de secteur, leurs salaires moyens et les secteurs qu'ils sont responsable?
...
--11)quels sont les nom de secteur et numero des parcelles des préférences du gardien 'ASC' et le chef de secteur des secteurs?
